...
public final class DBManager {
    ...
    public static boolean insertTicket(Connection connection, Ticket ticket) throws SQLException {
        ...
        statement.setInt(5, ticket.getCountBuy());
    ...
    public static boolean updateTicket(Connection connection, int ticketId, int countBuy) throws SQLException {
        PreparedStatement statement = connection.prepareStatement(SQLQuery.SQL_UPDATE_TICKET_COUNT_BUY);
        statement.setInt(1, countBuy);
        statement.setInt(2, ticketId);
    ...
    public static int getCountBuy(Connection connection, int ticketId) throws SQLException {
        PreparedStatement statement = connection.prepareStatement(SQLQuery.SQL_GET_COUNT_BUY);
    ...
    public static Ticket getTicketById(Connection connection, int tickedId) throws SQLException {
        ...
        if (result.next()) {
            ...
            ticket.setCountBuy(result.getInt(Fields.TICKET_COUNT));
            return ticket;
        }
