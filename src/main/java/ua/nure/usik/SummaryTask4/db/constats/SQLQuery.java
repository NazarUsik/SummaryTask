...
public final class SQLQuery {
    ...
    public static final String SQL_UPDATE_TICKET_COUNT_BUY =
            "UPDATE ticket SET count_buys = ? WHERE id = ?";
    ...
    public static final String SQL_GET_COUNT_BUY =
            "SELECT count_buys FROM ticket WHERE id = ?";
}
